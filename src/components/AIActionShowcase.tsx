      ...
      <div className="bg-dark-800 rounded-lg overflow-hidden shadow-2xl max-w-md mx-auto border border-dark-700">
        ...
        <div className="p-5">
          ...
          <div className="flex justify-end space-x-3">
            ...
            <motion.button 
              className="px-4 py-2 bg-primary-400 text-white rounded-md text-sm font-medium flex items-center"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              initial={{ opacity: 1 }}
              animate={{ 
  ...
  },
  {
    ...
    mockup: (
      <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
        ...
        {/* ElevenLabs AI Widget - Added Next to Outreach Sequence */}
        <motion.div
        ...
        >
          ...
          <div className="p-5">
            <div className="relative w-full h-60 bg-black flex items-center justify-center rounded-md border border-dark-700">
              {/* Embed ElevenLabs AI Widget */}
              <elevenlabs-convai agent-id="FeDHh9EmNfMMKCvrYZyn"></elevenlabs-convai>
      ...
      <div className="bg-dark-800 rounded-lg overflow-hidden shadow-2xl max-w-md mx-auto border border-dark-700">
        ...
        <div className="p-5">
            ...
            {[
              ...
              >
                ...
                <div className="flex justify-end mt-3 space-x-2">
                  <button className="text-xs text-primary-400 flex items-center hover:underline">
          ...
          <div className="mt-5 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button className="p-1 border border-gray-700 rounded">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="transform perspective-1200 rotateY-3 rotateX-3"
              >
                {activeItem.mockup}
              </motion.div>
            </div>
